...
import NormalAuto from "./Normal_auto/NormalAuto";
import BetValue from "./Bet_value/BetValue";
import ColorSelector from "./Color_selector/ColorSelector";
import PreviousCards from "./Previous_cards/PreviousCards";
import ActualCards from "./Actual_cards/ActualCards";
...
const Double = () => {
    ...
    //Animation states
    const {setCondition} = useContext(HeaderContext);
    const {setOperator, setAnimationValue} = useContext(HeaderContext);
    const {setAnimation} = useContext(HeaderContext);
    ...
    const betRegister = () => {
        ...
        setTimeout(() => {
            setAnimation({animation: "animation_discount 3s"})
        }, 100);
        setCondition(true);
        setOperator("-");
        setAnimationValue(inputValue);
